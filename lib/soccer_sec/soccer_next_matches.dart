...
class SoccerNextMatches extends StatefulWidget {
  const SoccerNextMatches({Key? key}) : super(key: key);

  @override
  _SoccerNextMatchesState createState() => _SoccerNextMatchesState();
}

class _SoccerNextMatchesState extends State<SoccerNextMatches> {
  @override
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const SizedBox(width: 5),
                        Flexible(
                          child: Image.asset('images/teams/macara_logo.png'),
                        ),
                      ],
                    ),
                    const Text('Liga Pro'),
